...
public class MediaRecord {
  ...
  @Id private Long id;
  @Column("filename") private String name;
  private String format;
  private int width;
  private int height;
  private String hash;
  @Column("extraction_status") private String extractionStatus;
  @Column("user_id") private Long userId;
  @Column("is_private") private boolean isPrivate;

  // --- NEW ROBUST METADATA FIELDS ---
  private String provider = "LOCAL";
  @Column("provider_id") private String providerId;
  private String description;
  @Column("photographer_name") private String photographerName;
  @Column("photographer_username") private String photographerUsername;
  @Column("camera_make") private String cameraMake;
  @Column("camera_model") private String cameraModel;
  private Integer iso;
  @Column("location_country") private String locationCountry;
  @Column("location_city") private String locationCity;
  @Column("stats_downloads") private Long statsDownloads;
  @Column("remote_url") private String remoteUrl;
  ...
  public String getPhotographerUsername() { return photographerUsername; }
  public void setPhotographerUsername(String photographerUsername) { this.photographerUsername = photographerUsername; }
