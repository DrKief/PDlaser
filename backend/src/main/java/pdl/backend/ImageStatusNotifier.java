...
public class ImageStatusNotifier {
    ...
    private final Map<Long, DeferredResult<ResponseEntity<Map<String, Object>>>> requests = new ConcurrentHashMap<>();

    public DeferredResult<ResponseEntity<Map<String, Object>>> waitFor(Long imageId, Long timeoutInMilliseconds) {
