...
public class SemanticExtractor {
    ...
    static {
        try {
            ...
            try (InputStream modelStream = SemanticExtractor.class.getResourceAsStream("/resnet50.onnx")) {
                if (modelStream != null) {
            ...
            try (InputStream labelStream = SemanticExtractor.class.getResourceAsStream("/imagenet_classes.txt")) {
                if (labelStream != null) {
