...
\textbf{Description :} The UI provides a dedicated "Download Original" action utilizing a standard S3 streaming mechanism with enforced \texttt{Content-Disposition: attachment} headers.
\vspace{1em}
