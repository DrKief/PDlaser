...
\textbf{Description :} Bleeding-edge environment: Java JDK 21, Spring Boot 4.0.5, BoofCV 1.3.0, ONNX Runtime 1.24.3, DJL 0.36.0, AWS SDK 2.42.32, PostgreSQL 18, \texttt{pgvector} 0.1.6, Garage v2.2.0. \\
...
\textbf{Description :} Modern SPA structure: TypeScript 6.0, Vue 3.5 (Composition API), Vite 8.0.8, Axios 1.15.0, Vue Router 5.0.4. \\
