...
The application utilizes a containerized microservices architecture. Configuration is split across three Docker Compose files depending on the target environment.
