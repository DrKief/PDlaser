...
<style scoped>
.view-wrapper { animation: fadeIn 0.4s ease-out; max-width: 1600px; margin: 0 auto; }
...
:root.cruelty .tag-pill { background: #FFFF00; color: #000; font-family: 'Impact'; text-transform: uppercase; border-radius: 0; }
</style>